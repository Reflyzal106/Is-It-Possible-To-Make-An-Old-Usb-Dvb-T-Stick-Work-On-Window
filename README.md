# [SOLVED] Is-It-Possible-To-Make-An-Old-Usb-Dvb-T-Stick-Work-On-Window
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/is-it-possible-to-make-an-old-usb-dvb-t-stick-work-on-window)
>
...
Try updating the driver to a version compatible with Windows 10, or use a compatibility mode with a recent Windows update.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/is-it-possible-to-make-an-old-usb-dvb-t-stick-work-on-window)**
